...
<body>
    ...
    <div class="text-center mb-20">
        <h1 data-aos="fade-right" data-aos-delay="100" data-aos-duration="2500">Nur Diantoro</h1>
        <h1>&</h1>
        <h1 data-aos="fade-left" data-aos-delay="100" data-aos-duration="2500">Lidya Rahma</h1>
    ...
    <div class="mx-4 mb-20">
        ...
        <div class="bg-white rounded shadow-md p-4 mb-2" data-aos="fade-right" data-aos-duration="1000">
        ...
        <div class="bg-white rounded shadow-md p-4" data-aos="fade-left" data-aos-duration="1000">
